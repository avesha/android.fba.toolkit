...
public class AppSettings extends BaseAppSettings {
	...
	private static final String PREF_SHOW_APP_POINT_RILES = "show_add_point_rules";
	...
	static boolean isShowAddPointRules(Context context) {
		SharedPreferences pref = getSharedPreferences(context);
		return pref.getBoolean(PREF_SHOW_APP_POINT_RILES, true);
	}

	static void setPrefShowAppPointRiles(Context context, boolean value) {
		SharedPreferences.Editor editor = getSharedPreferences(context).edit();
		editor.putBoolean(PREF_SHOW_APP_POINT_RILES, value);
		editor.commit();
	}
