...
public class MetaHelper extends MetadataHelper {
	...
	static{
		...
		lstCatalogClasses.add(CatalogSalesPoints.class);
		lstCatalogClasses.add(CatalogSalesAgents.class);
		lstCatalogClasses.add(CatalogTasks.class);
		lstCatalogClasses.add(CatalogExtraStorage.class);
