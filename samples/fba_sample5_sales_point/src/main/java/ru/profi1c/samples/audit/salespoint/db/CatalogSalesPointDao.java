 ...
 *
 */
public class CatalogSalesPointDao extends CatalogDao<CatalogSalesPoint> {

	public CatalogSalesPointDao(ConnectionSource connectionSource)
			throws SQLException {
		super(connectionSource, CatalogSalesPoint.class);
	}
