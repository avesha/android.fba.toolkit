...
/**
 * Табличная часть 'Серийные номера' документа 'Возврат товаров от покупателя'
 * @author Сидоров Сидор Петрович (sidor_sidoroff@mail.ru)
 *
 */
@DatabaseTable(tableName=DocumentVozvratTovarovOtPokupatelyaTPSeriinieNomera.TABLE_NAME, daoClass = DocumentVozvratTovarovOtPokupatelyaTPSeriinieNomeraDao.class) 
@MetadataObject(type=MetadataObject.TYPE_TABLE_PART, name=DocumentVozvratTovarovOtPokupatelyaTPSeriinieNomera.META_NAME)
public class DocumentVozvratTovarovOtPokupatelyaTPSeriinieNomera extends TablePart {
	
	/**
	 * Имя таблицы в базе данных
	 */
	public static final String TABLE_NAME = "DocumentVozvratTovarovOtPokupatelyaTPSeriinieNomera";
