 ...
 * (PreferenceActivity) c доступом к базе данных. Вы можете просто вызвать
 * {@link #getHelper()}, чтобы получить ваш класс помощника, или
 * {@link #getConnectionSource()}, чтобы получить {@link ConnectionSource}.
 */
public abstract class FbaDBPreferenceActivity extends FbaPreferenceActivity {
